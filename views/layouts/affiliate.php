...
<aside class="sidebar">
    ...
    <a href="/affiliate/fraud-report" class="nav-link <?= str_starts_with($_SERVER['REQUEST_URI'],'/affiliate/fraud-report')?'active':'' ?>">
...
<header class="topbar">
    ...
    <div style="display:flex;align-items:center;gap:8px;margin-right:8px">
        ...
        <div style="position:relative" id="aff-bal-wrap">
            <button onclick="toggleAffBal()" id="aff-bal-btn"
                ...
                style="display:flex;align-items:center;gap:6px;padding:5px 12px;border-radius:8px;background:linear-gradient(135deg,#F0FDF4,#DCFCE7);border:1px solid #86EFAC;color:#15803D;font-weight:700;font-size:13px;cursor:pointer;transition:box-shadow .15s">
        ...
        <!-- News Bell -->
        <a href="/affiliate/news" id="news-bell-wrap" style="position:relative;display:flex;align-items:center;padding:6px;color:var(--text-muted);text-decoration:none;border-radius:6px" title="News">
        ...
        <div style="position:relative" id="notif-wrap">
            <button onclick="toggleNotifDropdown()" style="background:none;border:none;cursor:pointer;padding:6px;border-radius:6px;color:var(--text-muted);position:relative" title="Notifications">
        ...
        <div style="position:relative" id="fa-wrap">
            <button onclick="toggleFraudAlerts()" id="fa-btn" title="Fraud Alerts" aria-label="Fraud Alerts"
                    style="background:none;border:none;cursor:pointer;padding:6px;border-radius:6px;color:var(--text-muted);position:relative">
        ...
        <!-- Live Support Chat -->
        <a href="/affiliate/support" style="background:none;border:none;cursor:pointer;padding:6px;border-radius:6px;color:var(--text-muted);text-decoration:none;display:flex;align-items:center;position:relative" title="Live Support" id="chat-bell">
    ...
    <div class="topbar-actions">
        ...
        <div class="user-menu" style="position:relative">
            <div class="user-avatar" style="background:#10B981"><?= strtoupper(substr(Auth::currentUser()['first_name']??'A',0,1)) ?></div>
            <span><?= Helpers::e(Auth::currentUser()['first_name']??'Affiliate') ?></span>
