...
<header class="topbar" style="background: linear-gradient(90deg, #a1c4fd 0%, #eac2da 100%); border-bottom: none;">
    ...
    <div style="display:flex;align-items:center;gap:8px;margin-right:8px">
        ...
        <!-- News Bell -->
        <a href="/affiliate/news" id="news-bell-wrap" style="position:relative;display:flex;align-items:center;padding:6px;color:#fff;text-decoration:none;border-radius:6px;opacity:0.95" title="News" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.95'">
        ...
        <!-- Live Support Chat -->
        <a href="/affiliate/support" style="background:none;border:none;cursor:pointer;padding:6px;border-radius:6px;color:#fff;opacity:0.95;text-decoration:none;display:flex;align-items:center;position:relative" title="Live Support" id="chat-bell" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.95'">
