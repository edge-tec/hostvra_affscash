...
<div class="grid-2 mb-3">
    <div class="card">
        <div class="card-header">
            <span class="card-title">Daily Payout Trend</span>
        </div>
...
<div class="card mb-3">
    ...
    <div class="card-body" style="position:relative;min-height:180px">
        ...
        <div id="offerChartEmpty" style="display:none;position:absolute;inset:0;align-items:center;justify-content:center;color:#9CA3AF;font-size:13px;flex-direction:column;gap:6px">No offer data for the selected period</div>
    </div>
</div>
...
(function(){
    ...
    mk('offerChart', { type:'bar', data:{ labels:shortNames, datasets:[
        { label:'Clicks',      data:offerClicks, backgroundColor:alpha(COLORS[0],0.75), borderColor:COLORS[0], borderRadius:4, xAxisID:'xClicks', order:2, maxBarThickness:22 },
        { label:'Conversions', data:offerConv,   backgroundColor:alpha(COLORS[1],0.75), borderColor:COLORS[1], borderRadius:4, xAxisID:'xConv',   order:2, maxBarThickness:22 },
