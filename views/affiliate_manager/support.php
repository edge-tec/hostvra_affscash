...
function renderReadReceipt(m) {
    if (parseInt(m.is_read) === 1 || m.status === 'read') {
        ...
        return '<span class="mc-read-receipt read" title="'+escHtml(tooltip)+'" style="margin-left:6px;display:inline-flex;align-items:center;gap:2px;color:#2563EB;font-size:10px;font-weight:600">'+
        ...
        return '<span class="mc-read-receipt delivered" title="Delivered" style="margin-left:6px;display:inline-flex;align-items:center;color:#64748B">'+
        ...
        return '<span class="mc-read-receipt sent" title="Sent" style="margin-left:6px;display:inline-flex;align-items:center;color:#94A3B8">'+
