...
<div class="page-header">
    <div><h1>Create Advertiser Account</h1><p>Manually create a new advertiser account</p></div>
...
<div class="card" style="max-width:600px">
    ...
    <div class="card-body">
        <form method="POST" action="/admin/advertisers/create">
            <?= Helpers::csrf() ?>
            ...
            <div class="form-row cols-2">
                <div class="form-group">
                    ...
                    <input type="email" name="billing_email" class="form-control" value="<?= Helpers::e($_POST['billing_email'] ?? '') ?>" placeholder="Same as email if empty">
                </div>
                <div class="form-group">
                    <label>Credit Limit ($)</label>
                    <input type="number" step="0.01" name="credit_limit" class="form-control" value="<?= Helpers::e($_POST['credit_limit'] ?? '0') ?>" min="0">
                </div>
            </div>
            <button type="submit" class="btn btn-primary" style="width:100%">Create Advertiser Account</button>
        </form>
    </div>
</div>
