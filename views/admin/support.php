...
.ac-send-btn:hover{box-shadow:0 4px 12px rgba(79,70,229,.3);}
.ac-send-btn:active{}
...
function renderReadReceipt(m) {
    if (parseInt(m.is_read) === 1 || m.status === 'read') {
        ...
        return '<span class="ac-read-receipt read" title="'+escHtml(tooltip)+'" style="margin-left:6px;display:inline-flex;align-items:center;gap:2px;color:#2563EB;font-size:10px;font-weight:600">'+
        ...
        return '<span class="ac-read-receipt delivered" title="Delivered" style="margin-left:6px;display:inline-flex;align-items:center;color:#64748B">'+
        ...
        return '<span class="ac-read-receipt sent" title="Sent" style="margin-left:6px;display:inline-flex;align-items:center;color:#94A3B8">'+
