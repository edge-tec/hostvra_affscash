...
.rw-tabs{display:flex;gap:10px;border-bottom:1px solid #E2E8F0;margin-bottom:18px;overflow-x:auto;-webkit-overflow-scrolling:touch}

.rw-grid{display:grid;grid-template-columns:380px 1fr;gap:18px;align-items:start;min-width:0;width:100%}
@media(max-width:1100px){ .rw-grid{grid-template-columns:1fr} }

.rw-editor{min-width:0;max-width:100%}
.rw-editor .form-control, .rw-editor input, .rw-editor select, .rw-editor textarea{max-width:100%;box-sizing:border-box}
.rw-editor .form-row{display:grid;gap:10px;min-width:0}
