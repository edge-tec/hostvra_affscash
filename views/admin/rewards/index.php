...
.rw-tab{display:inline-block;padding:8px 16px;font-size:13px;font-weight:600;color:#64748B;text-decoration:none;border-bottom:2px solid transparent}
.rw-tab.active{color:#4F46E5;border-color:#4F46E5}
.rw-tabs{display:flex;gap:10px;border-bottom:1px solid #E2E8F0;margin-bottom:18px}

.rw-grid{display:grid;grid-template-columns:380px 1fr;gap:18px;align-items:start}
@media(max-width:1100px){ .rw-grid{grid-template-columns:1fr} }

.rw-editor .form-row{display:grid;gap:10px}
.rw-editor .form-row.cols-2{grid-template-columns:1fr 1fr}
.rw-editor .form-row.cols-3{grid-template-columns:1fr 1fr 1fr}
@media(max-width:560px){ .rw-editor .form-row.cols-2,.rw-editor .form-row.cols-3{grid-template-columns:1fr} }

.rw-img-prev{position:relative;width:100%;aspect-ratio:16/9;background:#F1F5F9;border:1px dashed #CBD5E1;border-radius:8px;display:flex;align-items:center;justify-content:center;color:#94A3B8;overflow:hidden;margin-bottom:6px}
.rw-img-prev img{width:100%;height:100%;object-fit:cover}
.rw-img-prev .rw-empty{font-size:12px}

.rw-badge-chip{display:inline-flex;align-items:center;gap:6px;padding:4px 11px;border-radius:99px;font-size:11px;font-weight:700;color:#fff;letter-spacing:.02em;text-transform:uppercase}
.rw-badge-row{display:flex;flex-wrap:wrap;gap:6px;margin-top:4px}
...
.rw-table-wrap{background:#fff;border:1px solid #E2E8F0;border-radius:10px;overflow:hidden}
...
.rw-filter{display:flex;flex-wrap:wrap;gap:8px;align-items:center;margin-bottom:14px;background:#fff;border:1px solid #E2E8F0;border-radius:10px;padding:10px 12px}
.rw-filter input,.rw-filter select{height:34px;font-size:12.5px;padding:4px 10px;border:1px solid #E2E8F0;border-radius:6px;background:#fff}
.rw-filter .grow{flex:1;min-width:200px}
