...
<title>Login Blocked — <?= Helpers::e(Config::get('config','app.name') ?? 'AffiliateTracker') ?></title>
...
<div class="vpn-block-box">
    ...
    <div class="vpn-block-body">
        <div class="vpn-block-message">
            <p>Login is not allowed while using VPN or Proxy. Please disable your VPN/Proxy and try again.</p>
        </div>
        ...
        <div class="vpn-block-actions">
            <a href="/login" class="btn-retry">&#128260; Back to Login</a>
        </div>
    </div>
