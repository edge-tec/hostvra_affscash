...
.auth-header h1 { font-size:20px; font-weight:800; }
.auth-header p { font-size:13px; opacity:.85; margin-top:6px; line-height:1.5 }
...
<div class="auth-box">
    <div class="auth-header">
        ...
        if ($loginLogo):
        ?>
        <img src="<?= Helpers::e($loginLogo) ?>" alt="Logo" style="max-height:48px;max-width:180px;object-fit:contain;margin-bottom:14px;display:block;margin-left:auto;margin-right:auto<?= $loginLogoWhite ? ';filter:brightness(0) invert(1)' : '' ?>">
        <?php else: ?>
