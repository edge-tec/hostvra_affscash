...
$where  = ['c.clicked_at BETWEEN ? AND ?', 'c.source_override_applied = 1'];
...
$logs = Database::fetchAll(
    "SELECT c.id, c.click_id, c.ip_address, c.original_source, c.source as override_source, c.clicked_at,
