<?php
/**
 * In-House Short Link Generator
 * Called via AJAX from the affiliate in-house offers page.
 * POST /affiliate/inhouse-shorten
 * Body: { url: "https://...", offer_id: 5 }
 * Returns: { short_url: "https://shroo.link/xxxxx" }
 *
 * Uses the shroo.link API (same provider as /affiliate/shorten).
 */
