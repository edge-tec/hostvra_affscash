<?php
/**
 * Marketing - Tenant Custom Landing Page Controller
 */
$tenantId = (int)Tenant::getTenantId();
...
$offers = Database::fetchAll("SELECT id, name, payout_type, payout_amount FROM `offers` WHERE status = 'active' LIMIT 6");

require BASE_PATH . '/views/marketing/tenant_landing.php';
