...
import net.affscash.android.data.model.InvoiceResponse
import net.affscash.android.data.model.PdfDownloadResponse
...
class InvoiceRepository @Inject constructor(
    ...
    suspend fun getManagerInvoices(): Result<net.affscash.android.data.model.ManagerInvoicesResponse> = withContext(Dispatchers.IO) {
        try {
