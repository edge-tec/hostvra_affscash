...
interface ApiService {
    ...
    suspend fun updateAdminPlatformSettings(@Body request: com.example.affscash.data.model.AdminPlatformSettingsRequest): com.example.affscash.data.model.GenericResponse
}
